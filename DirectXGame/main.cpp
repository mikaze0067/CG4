...
#pragma region RTV用のDescriptorHeapを作成する
...
#pragma region DSV用のDescriptorHeapを作成する
...
#pragma region SRV用のDescriptorHeapを作成する
